...
public class RandomGenerator{
	...
	// a random list of words to generate a random description 
	// [ ] bug alert xx my bad, I wrote nouns and verbs. Now you have to do all three. 
	private static String[] personAdjectives = {"Smart","Talented","Quick","Friendly","Nice"};
	private static String[] personNouns = {"Student","Plumber","Mechanic","Friend", "Instructor" };
	...
	public static String getRandomPersonDescription(){
		int index = randomRoll(0, personAdjectives.length);
		int indexNoun = randomRoll(0, personNouns.length);
		String description = personAdjectives[index] + " " + personNouns[indexNoun];
		return description;
	}
